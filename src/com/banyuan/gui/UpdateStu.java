...
public class UpdateStu extends javax.swing.JFrame {
    ...
    /**
     * Creates new form UpdateStuAndQus
     */
    public UpdateStu() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("修改学生");

        jLabel2.setText("学生编号");

        jLabel3.setText("学生姓名");

        jLabel4.setText("学生密码");

        jLabel5.setText("学生成绩");
        ...
        jButton1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                try {
                    Client.dos.writeUTF("9," + jTextField3.getText() + "," + jTextField1.getText() + "," + jPasswordField1.getText() + "," + jTextField4.getText());
                    Client.dos.flush();
                } catch (IOException e) {
                    e.printStackTrace();
                }
