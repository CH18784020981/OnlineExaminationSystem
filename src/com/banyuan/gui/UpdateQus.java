...
public class UpdateQus extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("修改试题");

        jLabel2.setText("试题编号");
        ...
        jButton1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                dispose();
                AdminUpdateResult a = new AdminUpdateResult();
                a.setVisible(true);
            }
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateQus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
